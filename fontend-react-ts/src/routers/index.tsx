...
import { PATH_DASHOBARD, PATH_PUBLIC } from './paths';
    ...
    <Routes>
      ...
      <Route element={<Layout />}>
        ...
        <Route element={<AuthGuard roles={allAccessRoles} />}>
          <Route path={PATH_DASHOBARD.dashboard} element={<DashboardPage />} />
          <Route path={PATH_DASHOBARD.sendMessage} element={<SendMessagePage />} />
          <Route path={PATH_DASHOBARD.inbox} element={<InboxPage />} />
          <Route path={PATH_DASHOBARD.myLogs} element={<MyLogsPage />} />
          <Route path={PATH_DASHOBARD.user} element={<UserPage />} />
        </Route>
        <Route element={<AuthGuard roles={managerAccessRoles} />}>
          <Route path={PATH_DASHOBARD.manager} element={<ManagerPage />} />
        </Route>
        <Route element={<AuthGuard roles={adminAccessRoles} />}>
          <Route path={PATH_DASHOBARD.usersManagement} element={<UsersManagementPage />} />
          <Route path={PATH_DASHOBARD.updateRole} element={<UpdateRolePage />} />
          <Route path={PATH_DASHOBARD.allMessages} element={<AllMessagesPage />} />
          <Route path={PATH_DASHOBARD.systemLogs} element={<SystemLogsPage />} />
          <Route path={PATH_DASHOBARD.admin} element={<AdminPage />} />
        </Route>
        <Route element={<AuthGuard roles={ownerAccessRoles} />}>
          <Route path={PATH_DASHOBARD.owner} element={<OwnerPage />} />
        </Route>
        {/* Protected routes -------------------------------------------------- */}
